/*
WarmHook 2017, Dank Memes
Pasting since I joined CSGO hacking community
*/
//#define AYY_DEBUG
...
int InitialThread(LPVOID lpArguments)
{
	...
	Hooks::Initialise();
	ApplyAAAHooks();
	//MessageBox(NULL, "All offsets updated. Welcome to c0caine.", "Counter-Strike: Global Offensive", MB_OK);
	//AntiLeak->ErasePE();
