...
#define COL_WHITE			Color(30, 144,255, 255)
#define UI_COL_MAIN			Color(30, 144,255, 255)
#define UI_COL_MAINDARK		Color(30, 144,255, 255)
#define UI_COL_FADEMAIN		Color(30, 144,255, 255)
