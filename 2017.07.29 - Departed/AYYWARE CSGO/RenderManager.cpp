...
void Render::Initialise()
{
	...
	Fonts::Orion = Interfaces::Surface->FontCreate();
	Fonts::Watermark = Interfaces::Surface->FontCreate();

	Interfaces::Surface->SetFontGlyphSet(Fonts::Menu, "Helvetica-Bold", 14, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuBold, "Helvetica-Bold", 14, 900, 0, 0, FONTFLAG_ANTIALIAS);
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "Helvetica-Bold", 16, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Untitled1, "badcache", 35, 800, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuSymbols, "Tahoma", 16, 500, 0, 0, FONTFLAG_ANTIALIAS);
	Interfaces::Surface->SetFontGlyphSet(Fonts::Watermark, "AdobeGothicStd-Bold", 19, 500, 0, 0, FONTFLAG_ANTIALIAS);
