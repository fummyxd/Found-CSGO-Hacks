...
void    ImFontAtlas::GetTexDataAsRGBA32(unsigned char** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel)
{
    ...
    if (!TexPixelsRGBA32)
    {
        ...
        for (int n = TexWidth * TexHeight; n > 0; n--)
            *dst++ = IM_COL32(255, 255, 255, (unsigned int)(*src++));/*IM_COL32(255, 255, 255, (unsigned int)(*src++));*/
    }
...
ImFont* ImFontAtlas::AddFontDefault(const ImFontConfig* font_cfg_template)
{
    ...
    if (font_cfg.Name[0] == '\0') strcpy(font_cfg.Name, "AA American Captain.ttf, 13px");
...
void ImFont::RenderText(ImDrawList* draw_list, float size, ImVec2 pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width, bool cpu_fine_clip) const
{
    ...
    pos.x = (float)(int)pos.x + 0.5f/*DisplayOffset.x*/;
    pos.y = (float)(int)pos.y + 0.5f/*DisplayOffset.y*/;
    float x = pos.x;
    float y = pos.y;
    if (y > clip_rect.w)
        return;
